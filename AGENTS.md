...
This project is indexed by GitNexus as **Job-Market-Analytics-Platform** (1324 symbols, 2341 relationships, 100 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
