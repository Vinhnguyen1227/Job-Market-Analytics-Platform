...
This project is indexed by GitNexus as **Job-Market-Analytics-Platform** (1435 symbols, 2517 relationships, 106 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
