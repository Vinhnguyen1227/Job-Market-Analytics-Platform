...
MODEL_TOOL_CALL = os.environ.get("MODEL_TOOL_CALL", "careerintel-tool-call")
MODEL_HR_COACH = os.environ.get("MODEL_HR_COACH", "careerintel-hr-coach")
MODEL_STRUCTURED_GEN = os.environ.get("MODEL_STRUCTURED_GEN", "careerintel-structured-gen")
